    ...
    return Scaffold(
              ...
              children: [
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: Text('Login',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,letterSpacing: 2),
                        )),
                  ),
                ),
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Center(
                        child: Text('Sign Up',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 14,letterSpacing: 2),
                        )),
                  ),
                ),
      ...
      bottomNavigationBar: Padding(
        ...
        child: Container(
          ...
          width: MediaQuery.of(context).size.width,
          child: Text('BROWSE',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold,color: Colors.cyan,letterSpacing: 2),),
        ),
      ),
    );
  }
