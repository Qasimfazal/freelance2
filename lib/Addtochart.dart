                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(product.type == 0 ? 'Used':"New",
                                      style: TextStyle(
                                          fontSize: 13, fontWeight: FontWeight.w200,letterSpacing: 2)),
                                ],
                              ),
                            ),
                            Spacer(),
                            ...
                            children: [
                              InkWell(
                                ...
                                child: Container(
                                    ...
                                    child: Center(child: Text("MAKE OFFER", style: TextStyle(color: Colors.white,letterSpacing: 2, fontWeight: FontWeight.w800, fontSize: 10),))
                                ),
                              ),
                                        ...
                                        Padding(
                                          ...
                                          child: Row(
                                            children: [
                                              ...
                                              Text("BUY NOW", style: TextStyle(color: Colors.white,letterSpacing: 2, fontWeight: FontWeight.w800, fontSize: 10),),
                                            ],
                                          ),
                                        ),
                                        Text("Verified Authentication", textAlign:TextAlign.center,style: TextStyle(color: Colors.white,letterSpacing: 2, fontSize: 10,),),
                                      ],
                                    )
                                ),
                              ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text("Verified Authentic", style: TextStyle(color: Colors.lightBlueAccent,letterSpacing: 2),),
                                ],
                              ),
                              SizedBox(height: 30,),
                              Container(width: 300,
                                  child: Text("All items are sent to lay bull's authenticationteam for in-hand verification before being shipped out to you." ,
                                    style: TextStyle(color: Colors.lightBlueAccent,letterSpacing: 2),))
                            ],
                          ),
                        ),
                        // Text(
