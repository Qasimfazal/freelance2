                  ...
                  InkWell(
                    ...
                    child: Container(
                      height: 33,
                        ...
                        child: Center(child: Text("Sent", style: TextStyle(fontWeight: FontWeight.w800,fontSize: 11,color: Colors.white),))
                                        ),
                  ),
                  Spacer(),
                  InkWell(
                    ...
                    child: Container(
                      height: 33,
                        ...
                        child: Center(child: Text("Received", style: TextStyle(fontWeight: FontWeight.w800,fontSize: 11, color: Colors.grey[300]),))                    ),
                  ),
                            ...
                            child: Row(
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    SizedBox(height: 10,),
                                    Text(sentOffer[index].name, style: TextStyle(fontWeight: FontWeight.w700, fontSize: 16),),
                                    SizedBox(height: 8,),
                                    Text(sentOffer[index].type==0?"Used |":"New |" +sentOffer[index].size.toString(), style: TextStyle(color: Colors.grey),),
                                    SizedBox(height: 8,),
                                    Text("AED "+sentOffer[index].prices.toString(), style: TextStyle(fontWeight: FontWeight.w600, fontSize: 14),),
                                    SizedBox(height: 8,),
                                    InkWell(
                                      onTap: (){
